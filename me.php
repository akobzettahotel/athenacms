	...
	<body class="w3-theme-l5">
		...
		<div class="w3-top">
			<div class="w3-bar w3-theme-d2 w3-left-align w3-large">
				...
				<button class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-right">
					<?php
					...
					<div class="w3-card-2 w3-round">
						<div class="w3-white">
							...
							<button onclick="myFunction('Demo1')" class="w3-button w3-block w3-theme-l1 w3-left-align">
								<i class="fa fa-circle-o-notch fa-fw w3-margin-right"></i> Groups
							</button>
							...
							<div id="Demo1" class="w3-hide w3-container">
								...
								<div class="w3-row">
									<?php 
									$mygroup1 = mysqli_query($conn, "SELECT * FROM groups WHERE owner_id = '$athena[id]'");
								...
								<div class="w3-row">
									<?php 
									$mygroup3 = mysqli_query($conn, "SELECT * FROM group_memberships WHERE user_id = '$athena[id]'");
							...
							<div class="w3-card-2 w3-round w3-white">
								...
								<div class="w3-container w3-padding">
									...
									<p>
										...
										<input id="setting_motto" class="w3-input w3-border" type="text" value="<?php echo $athena["motto"]; ?>">
									</p>
									<hr>
									<p>
										<label class="w3-text-theme"><b>Allow user to add:</b></label>
									</p>
									<p>
										<div class="w3-row">
											<div class="w3-half">
												<label><input class="block_newfriends w3-radio" type="radio" name="block_newfriends" value="0" <?php if($athena["block_newfriends"] == "0"){ echo "checked"; } ?>>Yes</label>
											</div>
											<div class="w3-half">
												<label><input class="block_newfriends w3-radio" type="radio" name="block_newfriends" value="1" <?php if($athena["block_newfriends"] == "1"){ echo "checked"; } ?>>No</label>
											</div>
										</div>
									</p>
									<hr>
									...
									<p>
										<div class="w3-row">
											<div class="w3-half">
												<label><input class="hide_online w3-radio" type="radio" name="hide_online" value="0" <?php if($athena["hide_online"] == "0"){ echo "checked"; } ?>>Yes</label>
											</div>
											<div class="w3-half">
												<label><input class="hide_online w3-radio" type="radio" name="hide_online" value="1" <?php if($athena["hide_online"] == "1"){ echo "checked"; } ?>>No</label>
											</div>
										</div>
									</p>
									<hr>
									...
									<p>
										<div class="w3-row">
											<div class="w3-half">
												<label><input class="hide_inroom w3-radio" type="radio" name="hide_inroom" value="0" <?php if($athena["hide_inroom"] == "0"){ echo "checked"; } ?>>Yes</label>
											</div>
											<div class="w3-half">
												<label><input class="hide_inroom w3-radio" type="radio" name="hide_inroom" value="1" <?php if($athena["hide_inroom"] == "1"){ echo "checked"; } ?>>No</label>
											</div>
										</div>
									</p>
								</div>
						...
						<div class="w3-container">
							...
							<div id="friendrequest">
								...
								if($fr1 > 0)
								{
									...
									echo "
									<img src='https://avatar-retro.com/habbo-imaging/avatarimage?figure=$fr3[look]&headonly=1' alt='Avatar' style='width:50%'>
									<br>
